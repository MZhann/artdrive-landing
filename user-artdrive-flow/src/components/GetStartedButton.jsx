...
const SignUpButton = ({ h, lang }) => {
    ...
    return (
        ...
        <button
            ...
            } h-[32px] text-[14px] p-1  rounded-3xl bg-[#A8FF35] text-black text-center mb-10 font-montserrat  font-semibold hover:h-[35px] duration-200 transition-all ${h ? 'w-[124px] h-[32px] rounded-3xl bg-[#A8FF35] text-black text-center text-[14px] p-1 font-montserrat font-semibold hover:w-[220px] hover:h-[48px] mb-10 duration-200 transition-all'
               : 'w-[204px] h-[42px] rounded-3xl bg-[#A8FF35] text-black text-center text-[18px] p-1 font-montserrat font-semibold hover:w-[220px] hover:h-[48px] mb-10 duration-200 transition-all'
                }`}
        >
