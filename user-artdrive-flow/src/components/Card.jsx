...
const Card = ({ imageSrc, title, text, lang }) => {
    const translations = {
        "Rise to the Top":
            "Демонстрируй лучшие работы, соревнуйся и выигрывай потрясающие призы.",
        "Win BIG":
            "Призовые фонды не ограничены. Чем крупнее турнир, тем больше призовой фонд!",
        "Explode your audience":
            "Ускорь приток подписчиков и найди настоящих фанатов.",
        "Find true art gems":
            "Стань судьей турнира, зарабатывай призы и помоги нам найти лучший контент.",
    };
    ...
    const translatedTitle =
        lang === "en"
            ...
            ? "Взорви рост аудитории"
            : title == "Find true art gems"
            ? "Найди скрытый Бриллиант"
            : title;
