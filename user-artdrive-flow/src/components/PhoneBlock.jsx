                    ...
                    <div>
                        {language === "en" ? (
                            <div className="text-center md:hidden font-bold font-particiana scroll-section text-4xl mb-10 text-white">
                                ...
                                <span className="text-gradient">Likes</span>{" "}
                                into <br className="md:hidden"></br>
                                <span className="text-gradient">Dollars $</span>
                            </div>
                        ) : (
                            <div className="text-center md:hidden font-bold font-particiana scroll-section text-4xl mb-10 text-white">
                                Преврати{" "}
                                <span className="text-gradient">Лайки</span> в{" "}
                        ...
                        {language == "en" ? (
                            <div className="flex flex-col items-start">
                                ...
                                >
                                    ...
                                    Share your content and gain instant
                                    exposure.
                                </div>
                                <div
                                    className={`scroll-section ${textStyles(
                                        1
                                    )}`}
                                >
                                ...
                                >
                                    Stay ahead of the Game. Quickly find, test
                                    and{" "}
                            ...
                            <div className="flex flex-col items-start">
                                ...
                                >
                                    <span className={gradientTextStyles(0)}>
                                        Делись лучшим контентом,
                                    </span>{" "}
                                    {/* Share your <br className="hidden md:block" /> content and */}
                                    собирай лайки и зарабатывай.
                                </div>
                                <div
                                    className={`scroll-section ${textStyles(
                                        1
                                ...
                                >
                                    Быстро находи, тестируй и {" "}
                                    <span className={gradientTextStyles(2)}>
                                    проверяй свои контент идеи 
                                    </span>{" "}
                                    на живой аудитории.
                                </div>
                            </div>
