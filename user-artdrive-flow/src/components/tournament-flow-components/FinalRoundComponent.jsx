...
// import Image from "next/image";
// import ProgressBar from "./round-components/ProgressBar";
// import SingleArtComponent from './round-components/SingleArtComponent';
...
//             sendLikes();
//         }
//         setLikeDisabled(false); // Re-enable the like button for the next pair
//     };

//     const handleLike = (artId) => {
//         setLikedArtworks([...likedArtworks, artId]);
//         setLikeDisabled(true); // Disable the like button
//         handleNextPair();
//     };
...
//             <AnimatePresence>
//                 {selectedImage && (
//                     <SingleArtComponent handleClose={handleClose} image={selectedImage.image} onLike={handleLike} likeDisabled={likeDisabled} />
//                 )}
//             </AnimatePresence>
//         </div>
//     );
