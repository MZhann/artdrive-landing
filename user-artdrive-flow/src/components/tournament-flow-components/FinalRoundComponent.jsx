...
//                     <motion.div
//                         key={index}
//                         className={index === 0 ? `absolute top-8 w-full h-[505px] rotate-12 p-2 cursor-pointer ml-[150px]` : `absolute top-8 ml-[-150px] w-full h-[505px] -rotate-12 p-2 cursor-pointer`}
...
//             <AnimatePresence>
//                 {selectedImage && (
//                     <SingleArtComponent handleClose={handleClose} image={selectedImage.src} />
//                 )}
//             </AnimatePresence>
//         </div>
//     );
...
// const FinalRoundComponent = ({ totalParticipants, artworks, tournamentId }) => {
//     const [selectedImage, setSelectedImage] = useState(null);
//     const [currentArtPair, setCurrentArtPair] = useState([artworks[0], artworks[1]]);
...
//         const nextIndex = artworks.indexOf(currentArtPair[1]) + 1;
...
//         setLikedArtworks([...likedArtworks, artId]);
//         handleNextPair();
//     };
...
//                 currentArt={artworks.indexOf(currentArtPair[0]) + 1}
...
//             <AnimatePresence>
//                 {selectedImage && (
//                     <SingleArtComponent handleClose={handleClose} image={selectedImage.image} />
//                 )}
//             </AnimatePresence>
//         </div>
//     );
