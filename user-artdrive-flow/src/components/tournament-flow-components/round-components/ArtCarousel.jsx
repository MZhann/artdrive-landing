...
const ArtCarousel = ({
    ...
    return (
        <div className="relative w-full h-full flex flex-col items-center max-w-xl mx-auto">
            <motion.div
                className="relative w-[93%] border-[1px] border-gray-500 rounded-xl"
                initial={{ x: 0 }}
            ...
            >
                <Image
                    ...
                    width={600}
                    height={800}
                    className="rounded-xl w-[100%] sm:w-[100%] object-cover bg-purple-950 animate-bg-pulse h-[500px]"
                />
                {loading && (
            ...
            <div className="flex relative justify-between space-x-16 mt-10 mb-10">
                <button
