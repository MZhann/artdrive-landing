...
const TournamentResult = ({ tournamentId }) => {
    ...
    useEffect(() => {
        const fetchRankings = async () => {
            try {
                console.log("Fetching rankings for tournament ID:", tournamentId, "page:", page, "username:", username);
    ...
    return (
        <div className="bg-green-200 w-[90%] rounded-3xl bg-opacity-5 mt-10 border-2 border-gray-500 flex flex-col items-center">
            ...
            <div className="flex justify-center space-x-3 w-full">
                    ...
                    <div className="flex flex-col items-center mt-10">
                        <div className="relative">
                            <div className="w-[90px] h-[90px] border-2 border-gray-400 bg-gray-700 rounded-full overflow-hidden">
                                <Image src={rankings[1].artwork.image} alt={`Rank 2`} width={200} height={200} className="object-fit rounded-full " />
                            </div>
                ...
                {rankings.length > 0 && (
                    <div className="flex flex-col items-center">
                        <div className="relative">
                            <div className="w-[110px] h-[110px] border-2 border-gray-400 bg-gray-700 rounded-full overflow-hidden">
                                <Image src={rankings[0].artwork.image} alt={`Rank 1`} width={200} height={200} className="object-fit rounded-full " />
                            </div>
                    ...
                    <div className="flex flex-col items-center mt-20">
                        <div className="relative">
                            <div className="w-[80px] h-[80px] border-2 border-gray-400 bg-gray-700 rounded-full overflow-hidden">
                                <Image src={rankings[2].artwork.image} alt={`Rank 3`} width={200} height={200} className="object-fit rounded-full " />
                            </div>
